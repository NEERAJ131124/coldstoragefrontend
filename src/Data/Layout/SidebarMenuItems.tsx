...
export const menuItems: SidebarMenuItem[] = [
    {
        ...
        items: [
            ...
            },
            {
                ...
                type: "sub",
                children: [
                    { path: `${process.env.PUBLIC_URL}/facility/view`, type: "link", title: "View Facility" },
                    { path: `${process.env.PUBLIC_URL}/facility/add`, type: "link", title: "Add Facility" },
                ],
            },
            // {
            //     title: "Widgets",
    ...
    },
    {
        ...
        items: [
            ...
            // },
            {
                ...
                active: false,
                children: [
                    { path: `${process.env.PUBLIC_URL}/users/user_profile`, type: "link", title: "My Profile" },
            ...
            //     active: false,
            //     children: [
            //         { path: `${process.env.PUBLIC_URL}/location/country`, type: "link", title: "Country" },
            //         { path: `${process.env.PUBLIC_URL}/location/state`, type: "link", title: "State" },
            //     ],
            // },
    ...
    //                     type: "sub",
    //                     children: [
    //                         { title: "Error page 400", type: "link", path: `${process.env.PUBLIC_URL}/errors/error_400` },
    //                         { title: "Error page 401", type: "link", path: `${process.env.PUBLIC_URL}/errors/error_401` },
    //                         { title: "Error page 403", type: "link", path: `${process.env.PUBLIC_URL}/errors/error_403` },
    //                         { title: "Error page 404", type: "link", path: `${process.env.PUBLIC_URL}/errors/error_404` },
    //                         { title: "Error page 500", type: "link", path: `${process.env.PUBLIC_URL}/errors/error_500` },
    //                         { title: "Error page 503", type: "link", path: `${process.env.PUBLIC_URL}/errors/error_503` },
    //                     ],
    //                 },
    //                 {
